                                       ...
                                       Query_cache_block_table *block_table)
{
       ...
       tables_used= tables_used->next_global, n++, block_table++)
  {
    ...
    else
    {
      ...
      */
      if (tables_used->table->s->db_type()->flags & HTON_CAN_MERGE)
      {
        if (!tables_used->table->file->qcache_insert(this, block_table, n))
          DBUG_RETURN(0);
      }
    }
  }
    ...
    */
    ...
    else
    {
      ...
      */
      if (tables_used->table->s->db_type()->flags & HTON_CAN_MERGE)
      {
        table_count+= tables_used->table->file->qcache_table_count();
        --table_count;
      }
    }
  }
