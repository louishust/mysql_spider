...
void clean_up(bool print_message)
{
  ...
  */
  ...
  if (slave_transaction_retry_error_length)
    my_free(slave_transaction_retry_errors);
#endif
  my_tz_free();
...
static int get_options(int *argc_ptr, char ***argv_ptr)
{
  ...
  */
  ...
  if (opt_slave_transaction_retry_errors)
    init_slave_transaction_retry_errors(opt_slave_transaction_retry_errors);
#endif
